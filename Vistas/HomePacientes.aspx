<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePacientes.aspx.cs" Inherits="Vistas.HomePacientes" %>
    ...
    <form id="form1" runat="server">
        <!-- navbar-->
         ...
         <div class="contenido">
             ...
             <div class="usuario">
                 <asp:Label ID="lblUsuario" runat="server" Text="Bienvenido, Administrador"></asp:Label>
                 <asp:Label ID="lblFecha" runat="server"></asp:Label>
             </div>
        
             <h1>Menu Pacientes</h1>
        
             <div class="descripcion">
                 <p>Bienvenido al sistema de gestion de la clínica.En este menu podras:</p>
                 <ul>
                     <li>Agregar a pacientes.</li>
                     <li>Modificar los datos de pacientes.</li>
                     <li>Dar de baja a pacientes.</li>
             ...
             <div class="acciones">
                 <a class="boton" href="AgregarPaciente.aspx">Ir a Agregar</a>&nbsp;
                 <a class="boton" href="ListadoPacientes.aspx">Ir a Listar</a>
             </div>
         </div>
     </form>
</body>
