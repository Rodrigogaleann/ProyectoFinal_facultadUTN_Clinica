<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeUsuarios.aspx.cs" Inherits="Vistas.WebForm2" %>
        ...
        <!-- navbar-->
         ...
         <div class="contenido">
             ...
             <div class="descripcion">
                 <p>Bienvenido al sistema de gestion de la clínica.En este menú podrás:</p>
                 <ul>
                     <li>Listar los usuarios.</li>
                     <li>Modificar los datos de los usuarios.</li>
             ...
             <div class="acciones">
                 <a class="boton" href="ListadoUsuarios.aspx">Listar los usuarios</a>
             </div>
         </div>
     </form>
</body>
